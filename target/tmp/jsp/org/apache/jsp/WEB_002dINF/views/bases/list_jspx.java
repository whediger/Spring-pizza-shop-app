...
public final class list_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_page_list_0(PageContext _jspx_page_context)
    ...
    _jspx_th_page_list_0.setZ("nkW5fE9l0weFTNJ8/VKadCnYVOU=");
    _jspx_th_page_list_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${bases}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_page_list_0.setId("pl_com_springsource_roo_pizzashop_domain_Base");
  ...
  private boolean _jspx_meth_table_table_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_table_0.setZ("wmcSc70ZEacUEmtWLiD3AV/UHTk=");
    _jspx_th_table_table_0.setPath("/bases");
    _jspx_th_table_table_0.setId("l_com_springsource_roo_pizzashop_domain_Base");
    _jspx_th_table_table_0.setData((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${bases}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_table_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_0.setZ("fjFIKLciF6y0W4rrrhiELhxhQvM=");
    _jspx_th_table_column_0.setProperty("name");
    _jspx_th_table_column_0.setId("c_com_springsource_roo_pizzashop_domain_Base_name");
